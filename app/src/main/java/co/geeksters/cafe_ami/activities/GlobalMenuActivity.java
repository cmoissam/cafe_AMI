...
import co.geeksters.cafe_ami.adapter.MenuAdapter;
import co.geeksters.cafe_ami.events.failure.UnauthorizedFailureEvent;
import co.geeksters.cafe_ami.events.success.DeleteMemberEvent;
import co.geeksters.cafe_ami.events.success.EmptyEvent;
import co.geeksters.cafe_ami.events.success.RefreshRadarEvent;
import co.geeksters.cafe_ami.events.success.ResumeRadarEvent;
import co.geeksters.cafe_ami.events.success.SaveMemberEvent;
import co.geeksters.cafe_ami.events.success.SaveMemberForLogoutEvent;
import co.geeksters.cafe_ami.fragments.CreditFragment_;
import co.geeksters.cafe_ami.fragments.HubsFragment_;
import co.geeksters.cafe_ami.fragments.MarketPlaceFragment_;
import co.geeksters.cafe_ami.fragments.MeFragment_;
import co.geeksters.cafe_ami.fragments.MyToDosFragment_;
import co.geeksters.cafe_ami.fragments.NewPostFragment_;
import co.geeksters.cafe_ami.fragments.NewTodoFragment_;
import co.geeksters.cafe_ami.fragments.OneHubFragment_;
import co.geeksters.cafe_ami.fragments.OneProfileFragment_;
import co.geeksters.cafe_ami.fragments.PeopleDirectoryFragment_;
import co.geeksters.cafe_ami.fragments.PeopleFinderFragment_;
...
public class GlobalMenuActivity extends FragmentActivity {
    ...
    private String mTitle = "Cafe ami";
    String accessToken;
